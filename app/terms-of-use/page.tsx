...
export const metadata = {
  ...
  description: "ClassClarus Terms of Use. Please read these terms carefully before using our service.",
};
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-muted-foreground">
                By accessing or using ClassClarus (the &ldquo;Service&rdquo;), you agree to be bound by these Terms of Use 
                (&ldquo;Terms&rdquo;). If you do not agree to these Terms, you may not access or use the Service.
              </p>
              <p className="text-muted-foreground">
                If you are using the Service on behalf of a school, district, or other organization, you 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ClassClarus is a classroom gamification platform that enables teachers to motivate students 
                through points, behaviors, and rewards. The Service includes features for tracking student 
                behavior, managing classrooms, and creating engaging learning environments.
              </p>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8 mb-4">4. Guest Accounts</h2>
              <p className="text-muted-foreground">
                ClassClarus offers a guest mode that allows you to try the Service without creating a full 
                account. Guest account limitations include:
              </p>
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                <li>Data is automatically deleted after 14 days</li>
                <li>You can create classes and organizations but cannot join others&apos; classes</li>
                <li>Others cannot join classes you create</li>
                <li>To retain your data, you must create a full account before the 14-day period expires</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                You retain ownership of any content you create, upload, or input into the Service (&ldquo;User 
                Content&rdquo;), including class data, behaviors, rewards, and student information.
              </p>
              <p className="text-muted-foreground">
                By using the Service, you grant us a limited license to use, store, and process your User 
                Content solely for the purpose of providing the Service to you. We will not use your User 
                Content for any other purpose without your consent.
              </p>
              <p className="text-muted-foreground">
                You are responsible for ensuring that your User Content does not violate any laws or 
                third-party rights.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold mt-8 mb-4">7. Student Data</h2>
              <p className="text-muted-foreground">
                If you are a teacher or administrator using the Service with students, you represent and 
                warrant that:
              </p>
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                <li>You have the authority to consent to the collection of student data</li>
                <li>You have obtained any necessary consents from parents or guardians as required by law</li>
                <li>You will use the Service in compliance with FERPA, COPPA, and other applicable student privacy laws</li>
                <li>You will only input student information that is necessary for educational purposes</li>
              </ul>
              <p className="text-muted-foreground mt-4">
                We will process student data in accordance with our{" "}
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                are owned by ClassClarus and are protected by copyright, trademark, and other intellectual 
                property laws.
              </p>
              <p className="text-muted-foreground">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                The Service may integrate with third-party services (such as Google Classroom). Your use of 
                such integrations is subject to the terms and policies of those third parties. We are not 
                responsible for the content, privacy practices, or availability of third-party services.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold mt-8 mb-4">10. Payment and Subscriptions</h2>
              <p className="text-muted-foreground">
                Some features of the Service require a paid subscription. If you purchase a subscription:
              </p>
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li>We may change pricing with 30 days&apos; notice before your next renewal</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, CLASSCLARUS SHALL NOT BE LIABLE FOR ANY INDIRECT, 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                You agree to indemnify and hold harmless ClassClarus and its officers, directors, employees, 
                and agents from any claims, damages, losses, liabilities, and expenses (including reasonable 
                attorneys&apos; fees) arising out of or related to your use of the Service, your User Content, 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                Terms shall be resolved in the courts located in the United States.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                and ClassClarus regarding your use of the Service and supersede any prior agreements.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-none pl-0 text-muted-foreground space-y-2 mt-4">
                <li>Email: <a href="mailto:legal@classclarus.com" className="text-primary hover:underline">legal@classclarus.com</a></li>
