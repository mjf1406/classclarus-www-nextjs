...
export default function ContactPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const mailToLink = `mailto:support@classclarus.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Hello,\n\nI am ${firstName} ${lastName}.\nEmail: ${email}\n\n${message}`)}`;
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a 
                        href="mailto:support@classclarus.com" 
                        className="text-sm text-primary hover:underline"
                      >
                        support@classclarus.com
                      </a>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Your feedback helps us improve ClassClarus. We read every message.
                      </p>
                    </div>
                  </div>
                </CardContent>
